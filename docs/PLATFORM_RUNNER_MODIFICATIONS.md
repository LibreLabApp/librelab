...
This document lists all modifications made to the default platform runner templates generated by Flutter.

## Common

- Changed app ID to `app.librelab.librelab`.
  - App ID is hardcoded in `packaging/linux/app.librelab.librelab.desktop` and `flatpak-flutter.yml`.
- Changed the app display name to `LibreLab`.
