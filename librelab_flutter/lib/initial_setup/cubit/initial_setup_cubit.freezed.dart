...
mixin _$InitialSetupState {
 ...
 InitialSetupStep get currentStep; String? get nextButtonDisabledTooltip; String? get serverUrl;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is InitialSetupState&&(identical(other.currentStep, currentStep) || other.currentStep == currentStep)&&(identical(other.nextButtonDisabledTooltip, nextButtonDisabledTooltip) || other.nextButtonDisabledTooltip == nextButtonDisabledTooltip)&&(identical(other.serverUrl, serverUrl) || other.serverUrl == serverUrl));
}


@override
int get hashCode => Object.hash(runtimeType,currentStep,nextButtonDisabledTooltip,serverUrl);

@override
String toString() {
  return 'InitialSetupState(currentStep: $currentStep, nextButtonDisabledTooltip: $nextButtonDisabledTooltip, serverUrl: $serverUrl)';
}
...
@useResult
$Res call({
 InitialSetupStep currentStep, String? nextButtonDisabledTooltip, String? serverUrl
});
...
/// Create a copy of InitialSetupState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentStep = null,Object? nextButtonDisabledTooltip = freezed,Object? serverUrl = freezed,}) {
